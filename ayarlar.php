					...
					<form action="islemler/ajax.php" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
						...
						<div class="form-row">
							<div class="col-md-6 form-group">
								...
								<input type="text" class="form-control" name="footer_bilgi" value="<?php echo $ayarcek['footer_bilgi'] ?>">
							</div>
						</div>
						...
						<h5 class="font-weight-bold text-primary">Giriş Sayfası Düzenleme</h5>

						<div class="form-row">
							<div class="col-md-6 form-group">
								<label>Giriş Sayfası Üst Bilgi</label>
								<input type="text" class="form-control" name="footer_ust" value="<?php echo $ayarcek['footer_ust'] ?>">
							</div>
							<div class="col-md-6 form-group">
								<label>Giriş Sayfası Alt Bilgi</label>
								<input type="text" class="form-control" name="footer_alt" value="<?php echo $ayarcek['footer_alt'] ?>">
							</div>
						</div>
