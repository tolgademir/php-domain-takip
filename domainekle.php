                    ...
                    <form action="islemler/ajax.php" method="POST" accept-charset="utf-8">
                        <div class="form-row">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <select name="domain_musteri" class="form-control" id="musterilistesi"
                                    onchange="musterisecme()">
                                    <?php 
									$sorgu=$db->prepare("SELECT * FROM musteri");
									$sorgu->execute();
									while ($musteri=$sorgu->fetch(PDO::FETCH_ASSOC)) { ?>
                                    <option value="<?php echo $musteri['musteri_id'] ?>">
                                        <?php echo $musteri['musteri_isim'] ?></option>
                                    <?php }	?>
